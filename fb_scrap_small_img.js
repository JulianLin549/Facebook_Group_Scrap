                ...
                if (imgaTag) {
                    ...
                    for await (let fbImgLink of imgaTag) {
                        ...
                        if (/\/photo.php?(.*?)\"/.test(fbImgLink)) {
                            ...
                            await page.goto('https://mbasic.facebook.com/' + fbImgLink);

                            //找出真正的imgURL
                            await page.waitForXPath('//*[@id="objects_container"]/div/div[1]/div/div/div[1]/div/div[1]/div');
                            let [div3] = await page.$x('//*[@id="objects_container"]/div/div[1]/div/div/div[1]/div/div[1]/div');
                            if (div3) {
